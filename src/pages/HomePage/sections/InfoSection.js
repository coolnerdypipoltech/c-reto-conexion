  ...
  return (
    ...
    >
      ...
      <div className="info-section-container">
              <img src={image2} className="info-section__title" alt="title" loading="lazy"  />
      <img src={image3} className="info-section__subtitle" alt="subtitle" loading="lazy"  />
      <p className="info-section__text" >
COMPLETA EL RETO Y ASEGURA TU PARTICIPACIÓN EN EL SORTEO DE UNA DE LAS  <span style={{color: "#FFFF0D"}}>MÁS DE 1800 RECOMPENSAS.</span></p>
              <img src={image5} className="info-section__button" alt="button" loading="lazy"  />
      </div>
      

      <div className="info-section__container-1">
        <img src={image4} className="info-section__sticker1" alt="subtitle" loading="lazy"  />
      </div>
      <div className="info-section__container-2">
        <img src={image6} className="info-section__sticker2" alt="button" loading="lazy"  />
      </div>
